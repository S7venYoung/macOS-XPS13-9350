 ...
 *
 * Disassembly of /Users/sevenyoung/Downloads/XPS9350-macOS-master/DSDT/raw/SSDT-5.aml, Sat Nov  3 12:15:35 2018
 *
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x79ED0D98, 0x0138)
    ...
    Scope (\_SB.PCI0.IGPU)
    {
        ...
        Method (GSCI, 0, Serialized)
        {
            ...
            Method (SBCB, 0, Serialized)
            {
                ...
                If (LEqual (GESF, 0x07))
                {
                    If (LAnd (LEqual (S0ID, One), LLessEqual (OSYS, 0x07DF)))
                    {
